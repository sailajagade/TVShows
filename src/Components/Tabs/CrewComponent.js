  ...
  <div className="card-group">
    ...
    { text.person.image?
     <img className="card-img-top" src={
      text.person.image.medium} width="200px" height="170px"
...
//      { text.person.image?<img className="img-details card-img-top image-size" src={
//               text.person && text.person.image && text.person.image.medium
...
//      <div className="fontStyle">
//                     <b> {text && text.person && text.person.name}</b></div>
//                <div>as</div> 
//                 <div className="fontStyle">
//                 {text.person && text.person.name}
//                 </div>
...
//               {text.person.image ?<img className="card-img-top image-size"
//                 id="cast-image"
//                 src={
//                   text.person && text.person.image && text.person.image.medium
//                 }
...
//            }
//               </div>
//               <div className="col-lg-4  col-sm-6 col-4 offset-lg-3 offset-sm-1 offset-md-1 offset-5 ">
//                   {/* <div className="row m-x-auto m-b-2"> */}
//                   <div className="fontStyle">
//                     <b> {text && text.person && text.person.name}</b></div>
//                <div>as</div> 
//                 <div className="fontStyle">
